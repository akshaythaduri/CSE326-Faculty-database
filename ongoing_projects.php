...
<head>
      ...
      <title>On Going Projects Form</title>
  ...
  <body>
    ...
    <form action="ongoing_projects.php" method="post" enctype="multipart/form-data" id="faculty_profile">
      <h1>On Going Projects Details</h1>
      <fieldset>
